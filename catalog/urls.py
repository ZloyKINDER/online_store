...
from catalog.views import (CategoryCreateViews, CategoryListViews, CategoryUpdateViews, ContactView, ProductCreateView,
                           ProductDeleteViews, ProductDetailViews, ProductListViews, ProductUpdateViews)
